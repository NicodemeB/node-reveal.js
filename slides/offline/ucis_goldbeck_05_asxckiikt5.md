...
- Attacks of those alternative authentication systems
...
- Could be interesting to see how these biometric systems are "safe"→ and it’s scary how they are not/will not be for long
...
Complex rules (how many characters etc) digits special character
</aside>
...
<aside class="notes">
  ...
  - guess</br>
  - post-it </br></br>
  - such as the common password </br>
  - normal dictionary
</aside>
...
<aside class="notes">
 100 password requests per second.</br></br> The result is the approach that is the most effective way to hack that specific password </br></br>
...
<aside class="notes">
2 informations needed to get a device, limited over time extra steps, user understand it's more secure
...
Notes: 
- pin or passwords are frustrating
- biometrics can make it easier
-facial: select important points on the face distances & proportions
...
so security low but hard to duplicate</br></br>
...
<aside class="notes">
if password too hard to use </br>
...
Notes:
- Next : video of testing different smartphone with 2D and 3D face recognition
...
## Face recognition
<!-- .slide: data-background=" #c32c2c" -->
<iframe width="560" height="315" src="https://www.youtube.com/embed/ZwCNG9KFdXs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

VVVVV
<!-- .slide: data-background=" #c32c2c" -->
## Face recognition

→ 2D FR way more easily bypassed 
...
Notes:
- Not in video in this presentation but there are also tricks with twins
- Also in the beginning Apple's FaceID  had issues to distinguish Asian 
...
<small> L. O’Donnell, “Biometrics Flaws Uncovered to Bypass Apple FaceID,” threat post, 08-Aug-2019. [Online]. Available: https://threatpost.com/researchers-bypass-apple-faceid-using-biometrics-achilles-heel/147109/. [Accessed: 08-Dec-2019]. </small>
...
Previous videos: normal people; no real hacker skills 
...
Notes:
- Are given 9 points, usually laid out in the form of a keyboard. And they're asked to pick a gesture that connects those points together
- Whatever kind of gesture they want 
- These are biometrically based because even if someone else comes in, and tries to do the same gesture there will be subtle differences in the way two people enter it.
- Multi-touch
- Signature
...
- Gesture users enjoy being more secure
- Users prefer gesture to passwords
- Faster and less error-prone

Notes:
- makes parallel between user preference and usability
- easier to remember
...
Notes:
- Due to the intermediate contact point restriction
- the password space of the Android password pattern contains
- 389,112 possible patterns
- camera angles and lighting conditions under which latent “smudge patterns” can be recovered from touchscreen devices
...
It's not a human's social engineering </br>
...
<aside class="notes">
        ...
        allow to interact with alexa, siri,... </br></br>
