...
Notes:
  ...
  One conclusion for the first two parts and a break
...
- It was suggested last week | seems interesting 
- I've never had such course <- one is on coursera (don't know if those principles are in it)
...
- The temple was renovated, articles saying forbidden part of temple accessible for a few days
...
- concept that will help to explain scarcity effect
...
Notes:
- previous paraphrase= fear makes us take more risks 

- Same principle | different way to see it

- example of the book: 
 - show someone the cost of not changing inappropriate isolation more chance of him changing it than showing the benefit
...
- precious mistake:
post stamps or bills with defects worth much more despite being of a lesser quality just because of scarcity </br>
 side note: Google only find stuff about unwanted babies</br>

- Pushing to the maximum : not available
Sadly this one is already sold  - client asks if in reserve
...
Notes:
Number produced or shipped in Europe was limited (smth like that) </br></br>
You have to register to "get a chance" of buying it </br> scarcity ! competition!  and even delay!</br></br>

I had felt stupid to have missed the opportunity to buy it by missing that email</br>
...
Affect my view of the brand until today even though I am clueless


VVVVV

## More examples: The delay effect
...
Call 1
they use an address on wall street, have a name that inspires confidence
they ask if the client accepts to receive their advertisement
...
Delays prevent us from :</br>
 ...
 - under the impression that the opportunity will not present itself again</br></br>

speaking of liberty being reduced, we will now talk about reactance</br></br>

- In other words: our liberty reduced</br></br>

when something becomes rare or that something prevent us from having it we react in opposition to those forces  and we want it more
...
The energization Theory of Motivation:
...
Notes:
Each time our liberty of choice is threatened or restricted
...
## Reactance: The two-year-old children example

- Virginia University study
 - 2 toys equally desirable
   - one behind plexiglas
   - one in front of the child
 - plexiglas neither tall nor short enough for the child to grab the object behind 
...
the object was touched by children 3x faster than the object readily available
...
- before extension of his social environment

- an independent being - can make choice
- liberty - look for information about the limits
...
"Women have come a long way since the social pressure prevented them from smoking."
...
- Transition: Were the smoke better perceived? Let's see if restriction has an impact on perception with next example
 
- For more examples: Kennesaw gun law example pg 342, 343
...
- Regulation anti phosphate in Miami's county 
 - laundry products containing it is forbidden
...
Notes:
 ...
 - when liberty is restricted (rare item) our desire increases
...
- Two versions of an advertisement for a novel
...
read last
  ...
  - This one done on young adults</br>
...
## Effect of restrictions on information

- North Carolina University
- Speech against diversity in universities was banned
...
- this is a strong argument in favor of freedom of speech 
        
- Transition: Are only governmental restrictions considered as censorship?
...
- How tasty are those biscuits?
 - Tastier if there are 2 rather than 10
...
- see the abundance of the resource is reduced 

- If it's because of the demand, highest level of appreciation
        due to competition for limited resource
        IE. advertisements where shopper compete to get the item
        black Friday
        + fish example pg 361
...
- black Friday
- ABC pays 3.3 million for movie rights
...
- 1 million lost
- first-time movie offered through an auction
- competition
...
- KGB, military; government officials for the old regime
...
snob effect: "extent to which the demand for a consumer good is decreased owning to the fact that others are also consuming the same commodity" (Leibenstein, 1950, p. 189)
The Veblen effect: "extent to which the demand for a consumer good is increased because it bears a higher rather than a lower price"(Leibenstein, 1950, p. 189)
...
- The pressure doesn't come from using the rare object but to  own it
- Why do we want it?
...
- Stronger when we see the resource get scarcer
- Competition
...
- Which will lead us to the concept of artificial scarcity crucial for our today's talk
...
- <font size="6"> Article by Vishal Spara  from medium.com published on 8, 27 2018</font>
- <font size="6">  Concept: Purposeful limitations of an item's supply, even the technology, production and sharing capacity exists to create much greater abundance of items </font> 

-  <font size="6">   Couple common methods used to create artificial scarcity: </font> 
...
- Google search results to the question: Highlighted
...
Notes:
    - There is a very interesting article on Forbes about bitcoin halving: https://www.forbes.com/sites/forbesfinancecouncil/2019/05/10/what-will-the-next-halving-mean-for-the-price-of-bitcoin/#34a2ee785f34
...
- Research  Methodology
	- Design
		- Research was presented to participants as product test situation 
		- Participants evaluated three books and choose one of them
		- Availability condition: Limited availability of unlimited availability
	- Participants: 120 persons divided in two groups
...
non-constraining condition than in the constraining condition (LMC = 2.15
versus 2.49, p < 0.01).
...
to a market cause was evaluated as costlier and more nearly unique
