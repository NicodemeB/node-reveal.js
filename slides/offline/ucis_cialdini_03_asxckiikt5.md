...
Notes: 
- Illustrate two examples __used to introduce concepts__ in the book
	- Example of consistency introduced the __commitment effect__
	- Introduce the __tactics to obtain commitment__ + how long the pow stayed under the influence - another (slightly different) definition for the same effect (theory date back to 1957)
	- Illustrated by a cool experiment

- What it is
	-How sellers dedicate everything to those companies __focus on consistency__
...
or through the system that we do build
...
- The horse race betting illustration:
    - A study done by a pair of Canadian psychologists uncovered something fascinating about people at the racetrack: Just after placing a bet, they are much more confident of their horse’s chances of winning than they are immediately before lying down that bet.1 Of course, nothing about the horse’s chances actually shifts; it’s the same horse, on the same track, in the same field; but in the minds of those bettors, its prospects improve significantly once that ticket is purchased.
- New York City beach thieves staging:
	- 2 cases : 
		- Do not ask subjects on the beach to have a look to our stuff, have an accomplice stealing our the stuff, 
		- Ask subjects to have a look to the stuff,
	→ More subject chased the thief when they were asked to have a look at the stuff
...
- Like other forms of automatic responding, it offers a shortcut through the density of modern life
...
- The seasonal sale issue illustration
...
give __intuition commitment__ is how to obtain it

it was also a __solution__  to the __social proof principle__ 
so i guess we will see more examples of that in the next presentation
...
- They may take various shapes
- Some are straightforward; others are among the most subtle compliance tactics
- The door-to-door donations collection illustration

Notes:
Benjamin:
- Ask someone how he is doing before asking the real question : 
...
Notes:
- During the Korean war many American soldiers found themselves as POC camps run by Chinese
...
prisoners
- Problems faced by Chinese: how to get any collaboration at from men who were trained to provide nothing by name, rank and serial number?
Answer was sampling: start small  and build (foot in the door principle)

Tactics used:
- Prisoners were frequently asked to make so mildly (without anger) to anti American or pro-Communist such
   - The US is not perfect. In communist country unemployment is not a problem (small request)
- Push for bigger request
   ...
   - Later he might then be asked to read them in a discussion group with other prisoners
   - The Chinese then might use his name  and his essay in anti American radio broadcast
   - Aware that he had written the essay without any strong thread or coercion, many times a man
would change his image of himself to be consistent with the deed and with the new collaborator.

VVVVV
<!-- .slide: data-background=" #456789" -->

## Illustration and tenacity
...
- Recapitulative:
	...
	- PoW asked to do __small insignificant declaration__ against the U.S., __escalation__ leading to strong  __consistency__
	- Magic act: letters to families with censure  (__next chapter__)
...
- /!\ read after
- One stayed forever
- One refused more rations etc desiring to be treated equally - ended up leaving though
- In the us some were sent to asylum

My point => 
- Consistency defines who we are in your own eyes
...
- People's true feeling & belief comes less from their words than from their deed
	- The principle of self-perception
	- The principle of **written statement**:
		- Providing physical **evidence** that the **act occurred**;
		- Given a mechanism to influence others thinking with one's idea;
	- The influence of active commitment on consistency
		...
		- 2: From the **outside**: sneakier pressure → a tendency to adjust this image according to the way others perceive us.

Notes:
- The influence of active commitment on consistency: Once active commitment is made, self-image is squeezed from two sides by consistency pressure

VVVVV
#### The principle of written statement in the business world
...
- The public commitment principle
	- Public commitment tends to be lasting commitments
	- Whenever one takes a stand  that is visible to others, there arises a drive:
...
- Public commitment principle
	- To continue with the example of the Chinese POW: the Chinese constantly arranged to have pro-communist statement of their captives seen by others
- Illustration:
...
- The weight-loss:  
	- Weight-reduction clinics will require  down an immediate weight-loss goal and show that goal to as many friends, relatives and neighbors possible
- Woman stop smoking:
...
### The inner choice
- We've seen that:
- Commitment is most effective when active, public & effortful
...
- Very good price is offered  on a car (often below the competition)
...
- Consistency and commitment are generally good
...
- Both lies
	- One lies for money, and stay consistent to that (sufficient amount of money)
	- Other
		- No such incentive
		- Need a reason 
...
- "According to cognitive dissonance theory, there is a tendency for individuals to seek consistency among their cognitions" (definition from: https://www.instructionaldesign.org/theories/cognitive-dissonance/)
 - The cognitions in video ->  "beliefs, feelings or values"

- Consistency effect presented by cialdini -> more emphasis of justifying actions
	- Such as POW camps 
	- Cialdini's terms match this experiment a little better => cos no link with beliefs,feelings or values
...
Notes:
- Last example, regroup a few concepts
- We might have mentioned it but not for consistency
...
- We buy the right to sell the product for the company ("entry price")
...
Notes: 
- People make crazy claims, product help getting pregnant, cure cancer (in between a given time)
...
- People commit more and more:
	- Fill the garage 
	- But also involve their personal life

Notes: 
- Transition on personal life

VVVVV
<!-- .slide: data-background=" #456789" -->

## Multilevel Marketing: 
### Where is the consistency and commitment ?
...
### MLM: consistency and commitment 

- They sell a job and thus an entry price 
- They involve their entire social circle
	- Magic act + Public eye 
- No real gain -> Cognitive Dissonance experiment
- Advice comes from a friend -> Reciprocity and Similarity effects

Notes:
- They sell work -> entry price     => which is how money is made

- They use the social network,     => try to convince their close and distant acquaintances

	- Combination of magic act and public eye      
		- =>  lead to commitment and consistency effect
...
- Advice comes from a friend -> like in the Reciprocity and Similarity effects
