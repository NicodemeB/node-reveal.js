...
Notes:
- Physical attractiveness 
	- Halo effect, example + experiment (performance management)
- Similarity bias  
...
Notes: 
- Reciprocity
	- Start by playing game and winning something 
	- If you didn't win, you get something anyway
...
Notes:
- Liking rule 
	- It comes from a friend to every woman in the room
...
- Tupperware provides a percentage of the take 
	- People than buy *from* and *for* a friend 

Notes:
- The strength of that social bond is twice as likely to determine product purchases as his preference for the product
...
Notes: 
-Recruiting volunteers close to their own home 
...
- Appears even in the childhood
	- Research on elementary school 
		- Aggressive act seems to be less naughty when it is done by a good-looking child 
...
Notes:
- Kind of means for the short man  

→ Other examples in performance management 
...
- Experiment 
	- **Hippie and straight fashion**
		- Ask for 10 cents to call 
		- When dress in the same way get more often 10 cents
	- **Petitions**
...
- Put people in a way that they feel good 
...
- Same haircutter → derive from the performance evaluation 
- → We “**like**” people who are “**similar**” to us 
	- Get maximum score
...
### Similarity bias
<!-- .slide: data-background=" #c32c2c" -->
“““““Always possible to find some similarities””””””
...
- Send one card per month to customers 
...
- Same card and message for everyone 
...
Notes:
- Reciprocity : maybe asking a favor
>>>>>
...
- It depends on the amount of time we have been exposed before
...
Notes: 
- Faces of several individuals were flashed on a screen so quickly that later on, the subject who was exposed to the faces in this manner couldn't recall having seen any of them before
- The most the faces were flashed, the most the person was liked
...
<iframe width="280" height="157" src="https://www.youtube.com/embed/bk7mcfaa8fI?start=267" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- Jigsaw 
	- Student cooperates 
	- Became allies instead of enemies
- Consequences : 
...
Notes:
- Explain usual Bad VS good cop example 
- Contrast principle 
...
Notes:
- Role : charged to announce the result of the battle
...
- But if this state is full of farmers, they need water, there is always a "bad" side
...
- Athlete are used to promote 
	- Relevant to their role
		- Sport shoes, tennis rackets, golf balls 
	- Irrelevant 
		- soft, popcorn, 
...
- Important vote is made during the diner 
	- #Reciprocation 
...
- When they lose 
	- "They lose"
- We detach yourself from the bad event at anchor the good one
...
- Approach 
	- Timing approach:
		...
		- If we feel that an influence has been proceeded, let them know that you are aware 
		- Focus on the effect and not on the cause !
		- IE: if we like the practitioner without any reason, it smells fishy
