...
Notes: 
Milgram experiment 1963, Youtube sychHub 2014, (https://www.youtube.com/watch?v=Kzd6Ew3TraA, [last visited 14/12/2019]
...
- Legitimate authorities
	- Teachers, parents, physicians, policemen, ... 
- Src:
    - Extrait "Le jeu de la mort" (France 4) Documentaire, https://www.youtube.com/embed/KNV3b5MYVAE, [visited on 23/11/2019]
...
- Informative
	- "New information or arguments provided in a group discussion that changes a group member’s attitudes, beliefs, or behavior"
-  Mindless
...
- "Authority is physically closer to the participant"
- "Victim is physically further from the participant"
...
- Problem : Start beating them 
	- The watcher does not stop it so it means that it is a "normal" behaviour
- Src: 
...
- "Behavior is contagious, modeled by one followed by another."
	- "We follow tge behaviour of others to conform."
...
Notes:
- Personal experiment in formation for the scouts
- Src: 
...
- Experiments realized to check if this observation was biased 
	- Sadists : not representative of the average citizen
		- People of all ages, sex, occupations, educational level 
...
Notes: 
- The researcher, if necessary, ordered the subjects to perform their duties - shocking the actor (despite the emotional and physical damage they were causing)
...
![Absolutely Barbaric](https://framapic.org/random?i=r1FOwmVaReRM/Liqi2VNPkIFM)
...
- NDLR: why do you think there is such an important cut/separation of authority between the roles? Can you see the link, parallelism in this situation and the separation of power between legislative, executive and judiciary? If you do not enforce the separation, maybe there could be a risk that one of the power plays the role of the judge, the party, the executioner, etc.
- NDLR: "The third-leading cause of death in the US most doctors don’t want you to know about", Ray Sipherd, special to CNBC.com 2018-02-22 https://www.cnbc.com/2018/02/22/medical-errors-third-leading-cause-of-death-in-america.html (last access 2019-11-08T15:23)
...
Notes:
- Dosage: obviously said on the medication bottle that if was too much (max 10ml, and 20ml asked) 
