...
new message from aliens they have decided to let everyone survive because the little group had so much devotion - paraphrasing
...
- envelope containing a wallet adressed to the owner
  - contact information
...
VVVVV
 <!-- .slide: data-background="  #456789" -->
 <div style="background-color:black" align="left">    
<h6>The customer's surprising call</h6>
 </div> 
<img src="https://framapic.org/wSUyrsQlhXq8/hM7UnjTPgEhp.png" height="600">

VVVVV
 <!-- .slide: data-background="  #456789" -->
 <div style="background-color:black" align="left">    
<h6>From business insider</h6>
 </div> 
 <img src="https://framapic.org/C9AaiNIbYSui/hUtQWyddLha2.png" height="600">

Notes: 
    - source
    
Here’s why user reviews on sites like Amazon are such a big deal by Nick Vega 
    - https://www.businessinsider.com/amazon-reviews-greatly-impact-online-shopping-sales-2017-3?r=US&IR=T (Last opened 2019, Nov 28)
...
<h6>From business insider</h6>
 ...
 <img src="https://framapic.org/xWb3KQKrcrg4/VZigLEORJ5ny.jpg" height="600">

Notes: 
    - source: http://www.designtos.com/post_rating-sites-for-businesses_624270/  (Last opened 2019, Nov 28)

VVVVV   
 <!-- .slide: data-background="  #456789" -->
 <div style="background-color:black" align="left">    
<h6 >Key Take aways </h6>
 </div> 
 
-  <font size="6">This is one of the rarely documented experience I ever recorded</font>
-  <font size="6"> But in fact I receive hundreds of  similar calls </font>
- <font size="6"> Customer calling about features we did not advertise </font>
-  <font size="6">But may have  heard about them from other buyers  </font>
-  <font size="6"> Other buyers feedback can be true but contextual </font>
-  <font size="6"> This shows a pattern of shopping on amazon </font>
-  <font size="6"> buyers rely more on social proof to make  buying decision </font>
- <font size="6"> than information provided by the sellers themselves </font>

VVVVV   
 <!-- .slide: data-background="  #456789" -->
 <div style="background-color:black" align="left">    
<h6 >Sub-section summary </h6>
 </div> 
 
-  <font size="6"> Social proof plays a great role in online shopping experiences </font>
- <font size="6"> Buying decision may be based on reviews, feedback & testimonials than real information provided buy the sellers  </font>
- <font size="6"> This resulting into product social proof artificial creation as  its influence both buyers decision and ranking in various platform such as google, amazon etc ...  </font>
...
Notes: 
    ...
    - Unfortunately, these differences have been shown to substantially impact researchers’ efforts to evaluate their new designs or interventions.
    
-  In particular, usability studies and field evaluations frequently suffer from high levels of participant response bias , defined as the extent to which participants provide researchers with feedback or results  that will please the researchers or help to achieve the research goals 

- As a result, many researchers have found it challenging to obtain critical or negative feedback from participants that could help them to improve their designs or interventions 

VVVVV
 <!-- .slide: data-background="  #456789" -->
 <div style="background-color:black" align="left";>    
<h6>The evaluation task  </h6>
 </div> 

- <font size="6"> Working within an existing HCI project, the Projecting Health project in India,  participants to evaluate a community-created video </font>
- <font size="6"> Video featured a discussion between an ASHA, two representatives of a village-level committee,
and a local doctor on how to keep ground water clean </font>

VVVVV
 <!-- .slide: data-background="  #456789" -->
 <div style="background-color:black" align="left";>    
<h6>The experiment methology </h6>
 </div> 
 
-  <font size="6"> Controlled between-subject experiments that systematically influence participant response bias using the concept of social proof</font>
-  <font size="6">an online experiment with 245 workers recruited through Amazon’s Mechanical Turk (MTurk) platform</font>
-  <font size="6">Field experiment with 63 low-income, low-literate participants in rural India</font>
- <font size="6">Participants  randomly assigned to one of the 3 conditions: positive social proof, negative social proof, and no social proof </font>

Notes: 
- Conducted a series of controlled experiments that systematically influence participant response bias using the concept of social proof (or informational social influence) from the field of social psychology

- Prior to watching the video, participants in the positive and negative conditions received social proof through
subtle exposure to three positive and negative ‘video reviews’, respectively, that they perceived to have been provided byother participants ‘like them

VVVVV
 <!-- .slide: data-background="  #456789" -->
 <div align="left";>    
<h6><font size="6">The experiment methodology cont' </font></h6>
 </div> 

- <font size="6">Researchers authored 30 reviews in collaboration with the Projecting Health team</font>

<div style="margin-top: 25px;"  align="left";>    
<h6><font size="6">An example of a positive feedback </font></h6>
 </div> 
 
><font size="6">“It is very important for people to learn this information. The video content is great!</font>
...
<h6>Experiment I:Script used by the confederates to social proof participants </h6>
 ...
 <img src="https://framapic.org/JAJrN8AlRMgW/DevYb6Jop5wd.png" height="500"  >
