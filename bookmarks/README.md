...
* You add your bookmarks to the file `https://annuel.framapad.org/p/20192020_links_asxckiikt5/export/txt`.
...
Because the javascript attempts to open the `https://annuel.framapad.org/p/20192020_links_asxckiikt5/export/txt` file via a
